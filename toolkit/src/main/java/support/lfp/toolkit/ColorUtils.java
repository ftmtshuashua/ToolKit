 ...
 *      getRedRatio()       :获得颜色Red的比例
 *      getGreenRatio()     :获得颜色Green的比例
...
public class ColorUtils {
     ...
     * @return The ratio
     */
    public static float getRedRatio(@ColorInt int color) {
     ...
     * @return The ratio
     */
    public static float getGreenRatio(@ColorInt int color) {
     ...
     * @return The ratio
     */
    public static float getBlueRatio(@ColorInt int color) {
     ...
     * @return The ratio
     */
    public static float getAlphaRatio(@ColorInt int color) {
