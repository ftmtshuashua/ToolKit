...
public class ViewUtils {
    ...
    private static final int TAG_KEY_START = 3 << 24;
    ...
    /**
     * 获得通过 {@link ViewUtils#setImageResource(ImageView, int)} 方法设置的资源ID
     */
    public static final int getImageResource(ImageView view) {
    ...
    /**
     * 获得通过 {@link ViewUtils#setBackgroundResource(View, int)} 方法设置的资源ID
     */
