...
public class ServiceUtils {
     ...
     *                  </ul>
     */
    public static void bindService(final Context context, final String className, final ServiceConnection conn, final int flags) {
        try {
     ...
     *                </ul>
     */
    public static void bindService(final Context context, final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(context, cls);
