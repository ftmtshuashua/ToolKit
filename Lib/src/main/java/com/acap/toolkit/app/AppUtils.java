...
public class AppUtils {
    ...
    public static void installApp(final File file) {
        ...
        getApp().startActivity(IntentUtils.getInstallAppIntent(getApp(), file, true));
    }
    ...
    public static boolean installAppSilent(final File file, final String params, final boolean isRooted) {
        ...
        if (commandResult.successMsg != null
            ...
            Log.e(TAG, "installAppSilent successMsg: " + commandResult.successMsg + ", errorMsg: " + commandResult.errorMsg);
            return false;
        }
    }
    ...
    public static void launchApp(final String packageName) {
        if (Utils.isSpace(packageName)) return;
        getApp().startActivity(IntentUtils.getLaunchAppIntent(getApp(), packageName, true));
    }
    ...
    public static String getAppSignatureSHA1(final String packageName) {
        ...
        return SHAUtils.sha1(signature[0].toByteArray()).replaceAll("(?<=[0-9A-F]{2})[0-9A-F]{2}", ":$0");
    }
